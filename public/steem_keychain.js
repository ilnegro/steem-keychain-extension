...
var steem_keychain = {
   ...
   * @param {Object} comment_options Options attached to the blog post. Consult Steem documentation at <https://developers.steem.io/apidefinitions/#broadcast_ops_comment_options> to learn more about it
   * @param {requestCallback} callback Function that handles Keychain's response to the request
   * @param {String} [rpc=null] Override user's RPC settings
   */
   ...
   * @example
   * const keychain = window.steem_keychain;
   * keychain.requestTransfer(username, toUsername, amount.toFixed(3),'','STEEM',(response) => {
   *   console.log(response)
   * }, true);
   *
   * @param {String} account Steem account to perform the request
   ...
   * }
   *
   * @param {String} [username=null] Steem account to perform the request. If null, user can choose the account from a dropdown
   * @param {String} delegatee Account to receive the delegation
   * @param {String} amount Amount to be transfered. Requires 3 decimals for SP, 6 for VESTS.
   ...
   * @param {String} steem Amount of STEEM to be powered up
   * @param {requestCallback} callback Function that handles Keychain's response to the request
   * @param {String} [rpc=null] Override user's RPC settings
   */
   ...
   * }
   * @param {String} username Steem account to perform the request
   * @param {String} steem_power Amount of STEEM to be powered down
   * @param {requestCallback} callback Function that handles Keychain's response to the request
   * @param {String} [rpc=null] Override user's RPC settings
   */
   ...
   * if (window.steem_keychain) {
   *   const keychain = window.steem_keychain;
   *   keychain.requestCreateProposal('keychain', 'keychain', 'Steem Keychain development', 'steem-keychain-proposal-dhf-ran717', '10.000', '2022-03-22', '2023-03-21', JSON.stringify([]), (response) => {
   *     console.log(response);
   *   });
   * } else {
   *   alert('You do not have Steem Keychain installed');
   ...
   * @param {Boolean} collaterized true to convert STEEM to SBD. false to convert SBD to STEEM.
   * @param {requestCallback} callback Function that handles Keychain's response to the request
   * @param {String} [rpc=null] Override user's RPC settings
   */
   ...
   *   alert('You do not have Steem Keychain installed');
   * }
   * @param {String} [username=null] Steem account to perform the request
   * @param {String} to Steem account receiving the transfers.
   * @param {String} amount amount to be sent on each execution.
   * @param {String} currency STEEM or SBD on mainnet.
   ...
   * if (window.steem_keychain) {
   *   const keychain = window.steem_keychain;
   *   keychain.requestSwap('keychain', 'STEEM', 'DEC', 5, 1, estimatedSteps, (response) => {
   *     console.log(response);
   *   });
   * } else {
   *   alert('You do not have Steem Keychain installed');
   ...
   * @param {requestCallback} callback Function that handles Keychain's response to the request
   * @param {String} [rpc=null] Override user's RPC settings
   * @param {string} [partnerUsername=null] Partner Steem account hosting the widget
