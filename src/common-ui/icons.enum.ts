export enum SVGIcons {
  ...
  STEEM_ENGINE = 'wallet/steem-engine',
  ...
  MENU_BOTTOM_BAR_STEEM = 'menu/bottom-bar/steem',
  ...
  WALLET_SP_DELEGATIONS = 'wallet/hp/sp-delegations',
  ...
  WALLET_HISTORY_SP_DELEGATIONS = 'wallet/history/sp-delegations',
