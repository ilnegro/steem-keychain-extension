...
const Delegations = ({
  ...
  useEffect(() => {
    ...
    if (delegations.incoming) {
      ...
      setTotalIncoming(
        FormatUtils.toSP(totalIncomingVests.toString(), globalProperties),
      );
    } else {
    ...
    if (delegations.outgoing) {
      ...
      setTotalOutgoing(
        FormatUtils.toSP(totalOutgoingVests.toString(), globalProperties),
      );
    }

    const totalHp = FormatUtils.toSP(
    ...
    <div
      ...
      <div className="available-panel">
        ...
        <div className="value">
          {available && (
            <>
              {FormatUtils.formatCurrencyValue(available!)} {currencyLabels.sp}
            </>
          )}
          {!available && <>...</>}
        </div>
