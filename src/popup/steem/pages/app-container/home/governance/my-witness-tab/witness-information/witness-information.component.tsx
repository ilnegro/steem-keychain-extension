...
import { WitnessGlobalInformationComponent } from '@popup/steem/pages/app-container/home/governance/my-witness-tab/witness-information/witness-global-information/witness-global-information.component';
import { WitnessInformationParametersComponent } from '@popup/steem/pages/app-container/home/governance/my-witness-tab/witness-information/witness-information-parameters/witness-information-parameters.component';
...
const WitnessInformation = ({
  ...
  useEffect(() => {
    ...
    setWitnessRanking(
      ranking.filter(
        (witness: Witness) => witness.owner === activeAccount.name!,
      )[0],
    );
  }, [ranking]);
      ...
      <div className="witness-profile-container">
        <div className="witness-profile">
          <img
            ...
            src={`https://steemitimages.com/u/${activeAccount.name!}/avatar`}
            onError={(e: any) => {
