...
const SavingsPage = ({
  ...
  useEffect(() => {
    ...
    const sbdSavings = FormatUtils.toNumber(
      activeAccount.account.savings_sbd_balance,
    );
    const steemSavings = FormatUtils.toNumber(
      activeAccount.account.savings_balance,
    );
    const sbd = FormatUtils.toNumber(activeAccount.account.sbd_balance);
    const steem = FormatUtils.toNumber(activeAccount.account.balance);

    const liquidValue = watch('currency') === 'steem' ? steem : sbd;
    const savingsValue =
      watch('currency') === 'steem' ? steemSavings : sbdSavings;
