...
import { loadPendingUnstaking } from '@popup/steem/actions/token.actions';
...
const TokenPendingUnstake = ({
  ...
  const cancelUnstake = (pendingUnstake: PendingUnstaking) => {
    ...
    navigateToWithParams(Screen.CONFIRMATION_PAGE, {
      ...
      message: getMessage('html_popup_cancel_unstaking_message'),
      title: 'html_popup_pending_unstake',
      titleParams: [tokenInfo.symbol],
      fields: fields,
    ...
    <div className="pending-unstake-token-page">
      {tokenUnstaking?.length && totalUnstaking && totalUnstaking > 0 && (
        <div className="panel">
          <div className="total">
            <div className="label">
              {getMessage('html_popup_total_pending_unstake')}
            </div>
            <div className="value">
...
const mapStateToProps = (state: RootState) => {
  return {
    pendingUnstaking: state.steem.tokensPendingUnstaking,
