  ...
  for (const [index, notif] of rawNotifications.entries()) {
    ...
    switch (notif.operation_type) {
      ...
      case 'comment': {
        ...
        externalUrl = `https://steempro.com/@${payload.author}/${payload.permlink}`;
        break;
      }
      ...
      case 'curation_reward': {
        ...
        externalUrl = `https://steempro.com/@${payload.comment_author}/${payload.comment_permlink}`;
        break;
      }
      case 'comment_reward': {
      ...
      case 'interest': {
        message = 'notification_sbd_interest';
        messageParams = [
          payload.owner,
