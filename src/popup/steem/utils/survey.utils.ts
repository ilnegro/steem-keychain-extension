import { SurveyData } from '@popup/steem/pages/app-container/survey/survey.data';
import { SurveyInfo } from '@popup/steem/pages/app-container/survey/survey.interface';
